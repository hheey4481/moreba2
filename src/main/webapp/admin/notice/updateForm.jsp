...
<div class="container">
<form name="fromUpdate" action="NoticeUpdateAction.no" class="form-horizontal" method="post">
...
<c:set var="userId" value="<%=notice.getId()%>" />
                ...
                <a href="./NoticeListAction.no?pageNum=<%=nowpage%>" class="btn btn-primary"> 목록</a>
            </div>
        </div>
    </form>
    <hr>
