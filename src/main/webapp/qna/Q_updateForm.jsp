...
<div class="container">
    <form name="fromUpdate" action="QnaUpdateAction.ro" class="form-horizontal" method="post">
     ...
     s
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input name="name" class="form-control" value="<%=qna.getName() %>">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 control-label">제목</label>
            <div class="col-sm-5">
                <input name="subject" class="form-control" value="<%=qna.getSubject() %>">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 control-label">내용</label>
            <div class="col-sm-8" style="...">
                <textarea name="content" class="form-control" cols="50" rows="5"><%=qna.getContent() %> </textarea>
            </div>
        </div>
        <div class="form-group row">
